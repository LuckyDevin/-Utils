...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
	...
	public static final String DATE_FORMAT_TID = "yyMMddHHmmssSSS";
	 ...
	 * @return
	 */
	public static String getCurrentTidDate() {
		SimpleDateFormat sdf = new SimpleDateFormat(DATE_FORMAT_TID);
		String sDate = sdf.format(new Date());
		return sDate;
	}
	 ...
	 */
	static public java.util.Date getUtilDateFromStr(String str) throws ParseException {
	...
	// 2011-08-26 修改人：韩建新 修改内容：增加date为空值处理
	public static String getStringDate(Date date) {
		...
		Calendar cal = new GregorianCalendar();
		cal.setTime(date);
		return new StringBuffer().append(cal.get(Calendar.YEAR)).append("-").append((cal.get(Calendar.MONTH) + 1)).append("-").append(cal.get(Calendar.DAY_OF_MONTH)).toString();
	}
	...
	public static String getDayandhour(Date date) {
		Calendar cal = new GregorianCalendar();
		cal.setTime(date);
		return new StringBuffer().append(cal.get(Calendar.YEAR)).append("-").append((cal.get(Calendar.MONTH) + 1)).append("-").append(cal.get(Calendar.DAY_OF_MONTH)).append(" ").append(cal.get(Calendar.HOUR_OF_DAY)).toString();
	}
	...
	/*
	 * 计算两个日期之间相差的天数 判断两个日期之间差了多少天，不足一天，则按一天计算，即20.01天也算21天
	 */
	 ...
	 */
	public static Date parseDate(int year, int month, int day, int hour, int min, int sec) {
		Calendar cal = Calendar.getInstance();
	...
	/**
	 * 将日期按指定格式输出，日期格式在config.porperties文件中设定，如果没有设定，则以'yyyy-MM-dd HH:mm:ss'，
	 * <br>
	 * 如果日期的时间部分全为0，则不显示
	 */
	...
	public static void main(String[] args) throws ParseException {
		// System.out.println(shortTime(new Date()));
		//
		// System.out.println(DateUtils.countDayByDate(DateUtils.parseDate("2013-03-15
		// 10:19:04"), DateUtils.parseDate("2013-03-15 10:19:04")));

		// System.out.println(DateUtils.compareWithHour(DateUtils.parseDate("2013-03-20
		// 10:19:04"), DateUtils.parseDate("2013-03-20 10:59:059")));
		//
		//
		// System.out.println(DateUtils.addHours(DateUtils.parseDate("2013-03-20
		// 10:00:00"), -1));

		Date createDate = DateUtils.parseDate("2013-04-02");// 任意时间
		Date createDate2 = DateUtils.parseDate("2013-03-29");// 任意时间
		Date createDate3 = DateUtils.parseDate("2013-04-01");// 任意时间

		SimpleDateFormat f = new SimpleDateFormat("YYYY");

		Date date = f.parse("2015");
		Date date1 = f.parse("2002");
		// System.out.println(date.getTime());
		// System.out.println(date);
		// System.out.println(date1.getTime());
		// System.out.println(date1);
		long c = date.getTime() - date1.getTime();
		// System.out.println(c);
		// System.out.println(c/1000/60/60/24/365);

		// System.out.println("___"+c/1000/60/60/24);
		// System.out.println("___"+c/(1000*60*60*24));

		long a = 1000 * 3600 * 24 * 365l;

		// System.out.println("1 比 3 之后：" + createDate.after(createDate3));
		// System.out.println("2 比 3 之前：" + createDate2.before(createDate3));
	...
	public static boolean compare(Date dateOne, Date dateTwo) {
		if (dateOne == null || dateTwo == null)
			return false;
		return DateUtils.getYear(dateOne) == DateUtils.getYear(dateTwo) && DateUtils.getMonth(dateOne) == DateUtils.getMonth(dateTwo) && DateUtils.getDayOfMonth(dateOne) == DateUtils.getDayOfMonth(dateTwo);
	}
	...
	public static boolean compareWithHour(Date dateOne, Date dateTwo) {
		return DateUtils.getYear(dateOne) == DateUtils.getYear(dateTwo) && DateUtils.getMonth(dateOne) == DateUtils.getMonth(dateTwo) && DateUtils.getDayOfMonth(dateOne) == DateUtils.getDayOfMonth(dateTwo) && DateUtils.getHourOfDay(dateOne) == DateUtils.getHourOfDay(dateTwo);
	}
	...
	// 得到两个日期之间的所有周几的列表
	public static List<String> getWeekDayListOfTwoDate(String fromDate, String toDate, String weekDay) {
		List<String> daysList = new ArrayList<String>();
		String startDate = fromDate;
		String endDate = toDate;
		if (compareTwoDate(fromDate, toDate) > 0) {
	...
	// 得到两个日期之间的所有月初的列表
	public static List<String> getFirstDayListOfMonthInTwoDate(String fromDate, String toDate) {
		List<String> daysList = new ArrayList<String>();
		String startDate = fromDate;
		String endDate = toDate;
		if (compareTwoDate(fromDate, toDate) > 0) {
	...
	// 得到两个日期之间的所有季初的列表
	public static List<String> getFirstDayListOfSeasonInTwoDate(String fromDate, String toDate) {
		List<String> daysList = new ArrayList<String>();
		String startDate = fromDate;
		String endDate = toDate;
		if (compareTwoDate(fromDate, toDate) > 0) {
	...
	// 得到两个日期之间的所有年初的列表
	public static List<String> getFirstDayListOfYearInTwoDate(String fromDate, String toDate) {
		List<String> daysList = new ArrayList<String>();
		String startDate = fromDate;
		String endDate = toDate;
		if (compareTwoDate(fromDate, toDate) > 0) {
	...
	// 得到一个时间延后或前移几月的时间 添加人：韩建新 日期：2011-08-29
	...
	// 获取给定日期字符串的月第一天 添加人：韩建新 日期：2011-08-29
	...
	// 获取给定日期字符串的月最后一天 添加人：韩建新 日期：2011-08-29
	...
	// 得到两个日期之间的所有周几的列表 添加人：韩建新 日期：2011-08-29
	public static List<String> getDateUtilWeekDayListOfTwoDate(String fromDate, String toDate, String weekDay) {
		List<String> daysList = new ArrayList<String>();
		String startDate = fromDate;
		String endDate = toDate;
		if (compareTwoDate(fromDate, toDate) > 0) {
	...
	// 获得给定日期字符串的 -- "该周的日期" 添加人：韩建新 日期：2011-08-29
	...
	// 得到两个日期之间的所有月初的列表 添加人：韩建新 日期：2011-08-29
	public static List<String> getDateUtilFirstDayListOfMonthInTwoDate(String fromDate, String toDate) {
		List<String> daysList = new ArrayList<String>();
		String startDate = fromDate;
		String endDate = toDate;
		if (compareTwoDate(fromDate, toDate) > 0) {
	...
	// 得到两个日期之间的所有季初的列表 添加人：韩建新 日期：2011-08-29
	public static List<String> getDateUtilFirstDayListOfSeasonInTwoDate(String fromDate, String toDate) {
		List<String> daysList = new ArrayList<String>();
		String startDate = fromDate;
		String endDate = toDate;
		if (compareTwoDate(fromDate, toDate) > 0) {
	...
	// 获得给定日期字符串的季度最后一天 添加人：韩建新 日期：2011-08-29
	...
	// 得到两个日期之间的所有年初的列表 添加人：韩建新 日期：2011-08-29
	public static List<String> getDateUtilFirstDayListOfYearInTwoDate(String fromDate, String toDate) {
		List<String> daysList = new ArrayList<String>();
		String startDate = fromDate;
		String endDate = toDate;
		if (compareTwoDate(fromDate, toDate) > 0) {
	...
	// 获取给定日期字符串的年最后一天 添加人：韩建新 日期：2011-08-29
	...
	/**
	 * 日期格式转换,用于判断条件只到月份，形如：1990-8 转换成1990-08 添加人：韩建新 日期：2011-09-27
	 */
	...
	/**
	 * 用于页面显示格式为XXXX年XX月 添加人：韩建新 日期：2011-09-27
	 * 
	 */
	...
	/**
	 * 获取一年前今天的日期 添加人：韩建新 日期：2011-09-27
	 */
	...
	/**
	 * 获取半年前的日期 添加人：韩建新 日期：2011-09-27
	 */
	...
	/**
	 * 获取两年前年份 添加人：韩建新 日期：2011-09-27
	 */
	public static String getPrimaTwoYear() {
		SimpleDateFormat aSimpleDateFormat = new SimpleDateFormat("yyyy");
		GregorianCalendar aGregorianCalendar = new GregorianCalendar();
		aGregorianCalendar.set(Calendar.YEAR, aGregorianCalendar.get(Calendar.YEAR) - 2);
		String currentYearAndMonth = aSimpleDateFormat.format(aGregorianCalendar.getTime());
		return currentYearAndMonth;
	}

	/**
	 * 获取一月前的日期 添加人：韩建新 日期：2011-09-27
	 */
	public static String getPrimaMonth() {
		...
		// sdf.format(aGregorianCalendar.getTime());
		// return currentYearAndMonth;
	...
	/**
	 * 获取下个月的日期 添加人：韩建新 日期：2011-09-27
	 */
	...
	/**
	 * 获取统计时间段开始日期 添加人：韩建新 日期：2011-09-27
	 */
	public static String getSecStartDate(String statisticsFREQUENCE, String beginDate) {
		...
		if (statisticsFREQUENCE.equals("4")) {// 季
			...
			String beginDateMonth = beginDate.substring(beginDate.indexOf("-") + 1, beginDate.lastIndexOf("-"));
	...
	/**
	 * 获取统计时间段结束日期 添加人：韩建新 日期：2011-09-27
	 */
	public static String getSecEndDate(String statisticsFREQUENCE, String endDate) {
		if (statisticsFREQUENCE.equals("1")) {// 日
			return endDate;
		}
		if (statisticsFREQUENCE.equals("2")) {// 周
		...
		if (statisticsFREQUENCE.equals("3")) {// 月
			try {
				...
				Calendar calendar = Calendar.getInstance();
				calendar.setTime(date);
				int year = Integer.parseInt(endDate.substring(0, endDate.indexOf("-")));
				int month = Integer.parseInt(endDate.substring(endDate.indexOf("-") + 1, endDate.lastIndexOf("-")));
				calendar.set(year, month - 1, 1);
				int maxDayOfMonth = calendar.getActualMaximum(Calendar.DAY_OF_MONTH);

				return endDate.substring(0, endDate.lastIndexOf("-")) + "-" + String.valueOf(maxDayOfMonth);
		...
		if (statisticsFREQUENCE.equals("4")) {// 季
			...
			String endDateMonth = endDate.substring(endDate.indexOf("-") + 1, endDate.lastIndexOf("-"));
	...
	/**
	 * 获取上最近有数据的时间段开始日期， 添加人：韩建新 日期：2011-09-27
	 */
	public static String getPriveSecBegin(String statisticsFREQUENCE, String endDate) {
	...
	/**
	 * 功能：截取两个日期之间的天数 添加人：韩建新 日期：2011-09-27
	 * 
	 * @param String
	...
	public static int nbLeapDay(Date begin, Date end) {
		...
		if (getYear(beginDate) == getYear(endDate)) {
			...
			for (int i = getYear(beginDate); i <= getYear(endDate); i++) {
				if (isLeapYear(i) && beginDate.compareTo(getDateFromString(i + "-2-28")) < 0 && endDate.compareTo(getDateFromString(i + "-2-28")) > 0) {
					days++;
				}
			}
			return days;
	 ...
	 * @return
	 */
	public static String timestampStringDate(String idt) {
		if (idt != null && !idt.equals("")) {
			if (idt.contains("-")) {
				return idt;
			}
			Date date = new Date(Long.parseLong(idt));
			SimpleDateFormat sdf = new SimpleDateFormat(DATE_FORMAT_PAR);
			return sdf.format(date);
		}
		return null;
	...
	public static String yyyymmddTo(String str) {
		if(null != str){
